...
class TaskListView(GridView2):
    ...
    def invalidate(self):
        ...
        print(f"============== self.grid.columns =============")
        print(self.grid['columns'][0])
        print(self.grid['columns'][1])
        print(self.grid['columns'][2])
        print(self.grid['columns'][3])
        print(self.grid['columns'][4])
