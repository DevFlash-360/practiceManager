...
class PerformanceIncentiveView(GridView):
    def __init__(self, **kwargs):
        ...
        view_config = {
            ...
            'columns': [
                ...
                {'name': 'payment_date', 'label': 'Payment Date', 'format': 'dd MMM, yyyy'},
        ...
        super().__init__(model='PerformanceIncentive', view_config=view_config, filters=filters, **kwargs)
