...
class CaseUpdateForm(FormBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.next_activity = LookupInput(model='Activity', name='next_activity', label='Next Activity')
        self.next_date = DateTimeInput(name='next_date', label='Next Date', string_format='MMM dd, yyyy hh:mm a')
        self.todays_update = MultiLineInput(name='todays_update', label="Today's Update", rows=4)
