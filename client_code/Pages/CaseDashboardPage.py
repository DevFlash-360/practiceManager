...
class CaseDashboardPage(DashboardPage):
    ...
    def form_show(self):
        ...
        if self.case:
            ...
            panel_content += f"<h6>Retainer</h6>${(self.case['flat_fee_retainer'] or self.case['hourly_retainer']):,.2f}"
            ...
            panel_content += f"<h6>Investigator Budget</h6>${self.case['investigator_budget']:,.2f}"
